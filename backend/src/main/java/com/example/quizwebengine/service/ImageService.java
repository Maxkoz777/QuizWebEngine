...
import com.example.quizwebengine.exceptions.ImageNotFoundException;
import com.example.quizwebengine.model.userInfo.User;
import com.example.quizwebengine.model.util.ImageModel;
import com.example.quizwebengine.repository.ImageRepository;
...
public class ImageService {
    ...
    public ImageModel uploadImageToQuestion(MultipartFile file, Principal principal, Long questionID) throws IOException {
        User user = getUserByPrincipal(principal);
    ...
    public ImageModel getImageToQuestion(Long questionID) {
        ImageModel imageModel = imageRepository.findByQuestionId(questionID)
                .orElseThrow(() -> new ImageNotFoundException("Cannot find image to Post: " + questionID));
        if (!ObjectUtils.isEmpty(imageModel)) {
            imageModel.setImageBytes(decompressBytes(imageModel.getImageBytes()));
        }
        return imageModel;
