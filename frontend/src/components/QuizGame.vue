<template>
  <div class="full-height full-width question-container" v-if="currentQuestion && !isFinished">
    ...
    <div class="fixed-bottom-left q-pa-lg">
      <div class="q-ma-sm timer row justify-center items-center q-pa-md"
    ...
    <div class="row items-center justify-center q-gutter-lg">
      <div v-for="answer in currentQuestion.answer" :key="answer.answerId"
  ...
  <div v-else-if="isFinished" class="row justify-center items-center fullscreen text-white">
    <div class="text-center">
      <div class="text-h4">The quiz is finished !</div>
      <div class="text-h6 q-mt-md">Your score is: {{ score }} out of {{ questionsLength }}</div>
      <div>
        <q-btn flat class="accept-button q-mt-md" @click="visitMainPage" no-caps>
          Back to main menu
        </q-btn>
      </div>
    </div>
