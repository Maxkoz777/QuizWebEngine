  ...
  actions: {
    async fetchQuizData(context, quizId) {
      ...
      for (let questionId of questionIds) {
        const question = await context.dispatch(
          "fetchQuestion",
    ...
    async updateQuestions(context, newQuestionsData) {
      await axios.put(
        `question/${context.getters.currentQuestion.questionId}`,
        newQuestionsData
      );
      await context.dispatch("fetchQuizData", context.getters.quizId);
      await context.dispatch(
        "chooseQuestion",
        context.getters.currentQuestion.questionId
      );
    },
